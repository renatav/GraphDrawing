...
public class PlanarConvexEmbedding<V extends Vertex, E extends Edge<V>>  {
	...
	private void testSeparationPairs(){
		...
		try {
			...
			TriconnectedSplitting<V, E> triconnectedSplitting = new TriconnectedSplitting<V,E>(graph);
			List<HopcroftTarjanSplitComponent<V, E>> triconnectedComponents = triconnectedSplitting.formTriconnectedComponents(splitComponenets);
